...
const Summary: React.FC<SummaryProps> = ({ user }) => {
  ...
  const buildPdf = async () => {
    ...
    // evita crash si no está cargado el plugin
    if (typeof (doc as any).autoTable !== 'function') {
      alert('jsPDF AutoTable no está disponible. Revisa que cargues jspdf-autotable en index.html.');
      return;
    }
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                type="button"
                onClick={buildPdf}
                className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl font-bold text-sm shadow-md transition-all flex items-center gap-2"
              >
